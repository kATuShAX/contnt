...
/block <userid>
حضر شخص من الدردشه خاص (بالايدي)🚨

/unblock <userid>
الغاء حضر شخص من الدردشه خاص (بالايدي)🚨
...
/bc <text>
اذاعه للكل (الخاص والمجموعات)📫

/fwd <all/users/gps/sgps> (on reply)
اذاعه بالتوجيه (بالرد على التوجيه) 🔎

/echo <text>
لتكرار الكلام 

/addedmsg <on/off>
لتشغيل وايقاف الرد عند حفض الجهات 😐💋

/joinlinks <on/off>
لتشغيل وايقاف حفض معلومات المجموعات 🎞

/savelinks <on/off>
لتشغيل وايقاف حفض الروابط 🎞🛡

/addcontacts <on/off>
تشغيل و ايقاف حفض الجهات🔋

/setaddedmsg <text>
تعين رساله عند حفض الجهات ⌨️

/markread <on / off>
تشغيل وايقاف وضع القرائه 🔑👓

/setanswer '<word>'  <text>
ضبط <text> للرد التلقائي على كلمه <word>في الكروب 
🚨 :‌<word> باید داخل '' باشد
...
/autochat <on/off>
تشغيل و ايقاف الرد التلقائي ⌨️🕹️

/addmembers
لاضافة جهات البوت للمجموعه👥

/exportlinks
الارسال ملف لك يحتوي على روابط الكروبات🗄

/contactlist
الارسال ملف يحتوي على جهات الاتصال ومعلوماتهم 🎫

/addedcontact <on/off>
تشغيل وايقاف ارسال جهة البوت عند حفض الجهات☎️📞
